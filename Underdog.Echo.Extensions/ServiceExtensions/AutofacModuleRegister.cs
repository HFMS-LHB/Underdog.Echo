...
using Underdog.Echo.Extensions.AOP;
...
namespace Underdog.Echo.Extensions.ServiceExtensions
{
    public class AutofacModuleRegister : Autofac.Module
    {
        protected override void Load(ContainerBuilder builder)
        {
            ...
            var servicesDllFile = Path.Combine(basePath, "Underdog.Echo.Services.dll");
            var repositoryDllFile = Path.Combine(basePath, "Underdog.Echo.Repository.dll");
