...
namespace Underdog.Common.Seed
{
    public class FrameSeed
    {
        ...
        {
            Create_Model_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\Underdog.Model", "Underdog.Model.Models", tableNames, "", isMuti);
            return true;
        }
        ...
        {
            Create_IRepository_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\Underdog.IRepository", "Underdog.IRepository", tableNames, "", isMuti);
            return true;
        }
        ...
        {
            Create_IServices_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\Underdog.IServices", "Underdog.IServices", tableNames, "", isMuti);
            return true;
        }
        ...
        {
            Create_Repository_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\Underdog.Repository", "Underdog.Repository", tableNames, "", isMuti);
            return true;
        }
        ...
        {
            Create_Services_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\Underdog.Services", "Underdog.Services", tableNames, "", isMuti);
            return true;
        }
...
@"{SugarColumn}
            ...
            )
        {
            ...
            var ls = IDbFirst.IsCreateDefaultValue().IsCreateAttribute()
                 ...
                 .SettingClassTemplate(p => p =
@"using Underdog.IRepository.Base;
using Underdog.Model.Models" + (isMuti ? "." + ConnId + "" : "") + @";
    ...
    public interface I{ClassName}Services :IBaseServices<{ClassName}>" + (string.IsNullOrEmpty(strInterface) ? "" : (" , " + strInterface)) + @"
	{
          ...
          bool isMuti = false)
        {
            ...
            var ls = IDbFirst.IsCreateDefaultValue().IsCreateAttribute()
                  ...
                  .SettingClassTemplate(p => p =
@"using Underdog.IRepository" + (isMuti ? "." + ConnId + "" : "") + @";
using Underdog.IRepository.UnitOfWork;
using Underdog.Model.Models" + (isMuti ? "." + ConnId + "" : "") + @";
    ...
    public class {ClassName}Repository : BaseRepository<{ClassName}>, I{ClassName}Repository" + (string.IsNullOrEmpty(strInterface) ? "" : (" , " + strInterface)) + @"
    {
          ...
          bool isMuti = false)
        {
            ...
            var ls = IDbFirst.IsCreateDefaultValue().IsCreateAttribute()
                  ...
                  .SettingClassTemplate(p => p =
@"
using Underdog.IServices" + (isMuti ? "." + ConnId + "" : "") + @";
using Underdog.Model.Models" + (isMuti ? "." + ConnId + "" : "") + @";
